...
public class ViewPanel extends JPanel implements ActionListener {
    ...
    public ViewPanel(){
        ...
        JButton but4=new JButton ("Итог 1:  мин. цена для каждого статуса сотрудника");
        JButton but5=new JButton ("Итог 2:  общее число баз отдыха");
        JButton but6=new JButton ("Применить фильтр");
        JButton but7=new JButton ("Сортировать по базе и статусу отдыхающего");
        JButton but8=new JButton ("Сортировать по месяцу и статусу отдыхающего");
        JButton but9=new JButton ("Вывести все");
        tf=new JTextField("");
        JLabel l1 = new JLabel("Введите фильтр для названия базы",JLabel.CENTER);
    ...
    private void showTotal1(){
        TotalDialog td = new TotalDialog (MainFrame.frame,"Мин. цена для каждого статуса сотрудника:",
    ...
    private void showTotal2(){
        ...
        JOptionPane.showMessageDialog(MainFrame.frame,
            String.format("Общее число баз отдыха: %5d", Global.table.baseNumber()));
    }
    ...
    private void showFilter(){
        ...
        MainFrame.MSG.setText(String.format("Запрос на выборку: выдать записи с путевками, начинающейся с \"%s\"", filter));
        Global.updateJTable(Global.table.filterBaseName(filter).getResults());
        tf.setText("");
    }

    private void showSort1(){
        MainFrame.MSG.setText("Запрос на выборку: выдать все записи таблицы с сортировкой по месяцу и статусу отдыхающего");
