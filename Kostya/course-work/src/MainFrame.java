...
public class MainFrame implements ActionListener{
    ...
    public   MainFrame(){
        Global.table = new ResultGroup("Список записей о стоймости отдыха на базах отдыха предприятий");
        ...
        myC.add(new JLabel("Стоймость отдыха на базах отдыха предприятий", JLabel.CENTER), BorderLayout.NORTH);
